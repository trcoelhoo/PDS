...
public class PDS2122 {
	...
	private static void question2(PrintStream out) {
		...
		market2.addF("products.txt");
		market2.addArr(cars);

		out.println("--- All Products ---\nTotal: "+market2.totalProducts());
		for (Product item : market2.getProducts())
			out.println("\t"+item);	
	...
	private static void question3(PrintStream out) {
		...
		market3.share("ZA11ZB", u1);
		market3.share(cars[2], u2);

		out.println("--- Shared Products ---\n" + market3.sharedProducts());
		market3.giveBack(cars[0]);
		market3.giveBack("BB44ZB");
		out.println("--- Shared Products ---\n" + market3.sharedProducts());
