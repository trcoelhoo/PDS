...
public class JGalo extends JFrame implements ActionListener {
	...
	/**
	 * Chooses who the starting player is by reading the input arguments
	 * If none is given uses the default value ('X')
	 * 
	 * @param args the arguments from the command line
	 * @return 	returns a char with either 'O' or 'X'
	 */
	...
	public static void main(String args[]) {
		...
		myGreatGame myGreatGame = new myGreatGame(choice) ;
