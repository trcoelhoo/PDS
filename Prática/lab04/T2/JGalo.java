...
public class JGalo extends JFrame implements ActionListener {
	...
	public JGalo(JGaloInterface myGame) {
	...
	public static char argsChecker(String args[]) {

		if (args.length == 1) {
			if (args[1].toUpperCase().equals("O"))
				return 'O';
		}
		return 'X';
	...
	public static void main(String args[]) {
		char symb;
		// check args here!
		symb = argsChecker(args);
		System.out.println("symb is -> " + symb);
		myGame game = new myGame(symb);
		new JGalo(game);
	}
}
